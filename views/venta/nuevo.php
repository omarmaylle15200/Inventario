...
<body>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="txtProducto" list="dlProducto" autocomplete="off">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mt-1 mb-1">
                                    ...
                                    <select id="cboTipoDocumentoVenta" data-live-search="true" class="form-control" required>
                                    </select>
                                </div>
                                <div class="col-md-4">
    ...
    <script src="<?php echo constant('URL'); ?>public/js/ventaNuevo.js"></script>
